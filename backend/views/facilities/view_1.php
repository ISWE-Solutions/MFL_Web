                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    ?>
                                    <?=
                                            $form->field($model, 'province_approval_status')
                                            ->dropDownList(
                                                    [1 => "Accept & Send for national approval", 2 => "Send back for more information"], ['custom' => true, 'prompt' => 'Select Action', 'required' => true]
                                    );
                                    ?>
                                    <?=
                                    $form->field($model, 'verifier_comments', ['enableAjaxValidation' => true])->textarea(['rows' => 6, 'placeholder' =>
