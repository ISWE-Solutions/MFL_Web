...
class Facility extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            ...
            [['date_approved', 'date_created', 'date_updated', 'geom', 'verifier_comments', 'approver_comments','service_category','service'], 'safe'],
            ...
            [['coordinates'], 'safe'],
            [['operational_status'], 'exist', 'skipOnError' => true, 'targetClass' => \backend\models\Operationstatus::className(), 'targetAttribute' => ['operational_status' => 'id']],
            [['type'], 'exist', 'skipOnError' => true, 'targetClass' => \backend\models\Facilitytype::className(), 'targetAttribute' => ['type' => 'id']],
            [['district_id'], 'exist', 'skipOnError' => true, 'targetClass' => \backend\models\Districts::className(), 'targetAttribute' => ['district_id' => 'id']],
            [['ownership'], 'exist', 'skipOnError' => true, 'targetClass' => \backend\models\FacilityOwnership::className(), 'targetAttribute' => ['ownership' => 'id']],
        ];
    }
